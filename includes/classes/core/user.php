<?php
	...
	class User extends PdoObject
	{
		...
		public $size;
		public $tmp_path;
		public $image_placeholder = '//via.placeholder.com/400x400&text=image';
		...
		/**
		 * if image present return image else placeholder
		 *
		 * @return string
		 */
		...
		/**
		 * Auto save user whether there is an image present or not
		 *
		 * @return bool
		 */
		...
		/**
		 * Delete User and all files and records associated
		 *
		 * @return bool
		 */
		...
		/**
		 * Return user id if logged else redirect to login page
		 *
		 * @return mixed
		 */
