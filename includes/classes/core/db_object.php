<?php
	...
	class Db_object
	{
		...
		/**
		 * Get single data by id in a named array
		 *
		 * @param $id
		 *
		 * @return bool|mixed
		...
		/**
		 * Get showcase data by show_id in a named array
		 *
		 * @param $id
		 *
		 * @return array|bool
		...
		/**
		 * Search DB by passing an array of key value pairs
		 *
		...
		/**
		 * Delete DB row by array or key value pairs
		 *
		...
		/**
		 * Count all row by condition of array or key value pairs
		 *
