...
<?php $__env->startSection('page-id', 'uploads'); ?>

<?php echo $__env->make('includes.reveal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            ...
                            <div class="grid-x grid-margin-x">
                                <div class="medium-7 cell">
                                        ...
                                        <div class="grid-x grid-padding-x">
                                            <div class="medium-4 cell">
                                                <label for="blocknoticetitle1">Title
                                                    <input name="blocknoticetitle1" id="blocknoticetitle1" type="text" placeholder="Give this block a title" value="<?php echo e(!empty($threeBlockNotice->blocknoticetitle1) ? $threeBlockNotice->blocknoticetitle1 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticefaicon1">Icon
                                                    <select name="blocknoticefaicon1" id="blocknoticefaicon1">
                                                        <?php $__currentLoopData = $fontAwesome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php if($font['class'] === $threeBlockNotice->blocknoticefaicon1): ?>
                                                                <option selected value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php endif; ?>
                                                ...
                                                <label for="blocknotice_colorselector1">Select foreground color
                                                    <input class="form-control colorselector" type="text" name="blocknotice_colorselector1" id="blocknotice_colorselector1" value="<?php echo e(!empty($threeBlockNotice->blocknotice_colorselector1) ? $threeBlockNotice->blocknotice_colorselector1 : '##0a0a0a'); ?>" placeholder="Select foreground color" />
                                                </label>

                                                <label for="blocknoticesubtitle1">Subtitle
                                                    <input name="blocknoticesubtitle1" id="blocknoticesubtitle1" type="text" placeholder="Give this block a subtitle" value="<?php echo e(!empty($threeBlockNotice->blocknoticesubtitle1) ? $threeBlockNotice->blocknoticesubtitle1 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticedescrip1">Description
                                                    <textarea name="blocknoticedescrip1" id="blocknoticedescrip1"  placeholder="Give this block a short description"><?php echo e(!empty($threeBlockNotice->blocknoticedescrip1) ? $threeBlockNotice->blocknoticedescrip1 : ''); ?></textarea>
                                                </label>
                                            </div>
                                            <div class="medium-4 cell">
                                                <label for="blocknoticetitle2">Title
                                                    <input name="blocknoticetitle2" id="blocknoticetitle2" type="text" placeholder="Give this block a title" value="<?php echo e(!empty($threeBlockNotice->blocknoticetitle2) ? $threeBlockNotice->blocknoticetitle2 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticefaicon2">Icon
                                                    <select name="blocknoticefaicon2" id="blocknoticefaicon2">
                                                        <?php $__currentLoopData = $fontAwesome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                            <?php if($font['class'] === $threeBlockNotice->blocknoticefaicon2): ?>
                                                                <option selected value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php endif; ?>
                                                ...
                                                <label for="blocknotice_colorselector2">Select foreground color
                                                    <input class="form-control colorselector" type="text" name="blocknotice_colorselector2" id="blocknotice_colorselector2" value="<?php echo e(!empty($threeBlockNotice->blocknotice_colorselector2) ? $threeBlockNotice->blocknotice_colorselector2 : '##0a0a0a'); ?>" placeholder="Select foreground color" />
                                                </label>

                                                <label for="blocknoticesubtitle2">Subtitle
                                                    <input name="blocknoticesubtitle2" id="blocknoticesubtitle2" type="text" placeholder="Give this block a subtitle" value="<?php echo e(!empty($threeBlockNotice->blocknoticesubtitle2) ? $threeBlockNotice->blocknoticesubtitle2 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticedescrip2">Description
                                                    <textarea name="blocknoticedescrip2" id="blocknoticedescrip2"  placeholder="Give this block a short description" ><?php echo e(!empty($threeBlockNotice->blocknoticedescrip2) ? $threeBlockNotice->blocknoticedescrip2 : ''); ?></textarea>
                                                </label>
                                            </div>
                                            <div class="medium-4 cell">
                                                <label for="blocknoticetitle3">Title
                                                    <input name="blocknoticetitle3" id="blocknoticetitle3" type="text" placeholder="Give this block a title" value="<?php echo e(!empty($threeBlockNotice->blocknoticetitle3) ? $threeBlockNotice->blocknoticetitle3 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticefaicon3">Icon
                                                    <select name="blocknoticefaicon3" id="blocknoticefaicon3">
                                                        <?php $__currentLoopData = $fontAwesome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                            <?php if($font['class'] === $threeBlockNotice->blocknoticefaicon3): ?>
                                                                <option selected value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo e($font['class']); ?>" >&#x<?php echo e(ltrim($font['unicode'], '\/')); ?>; - <?php echo e($font['name']); ?></option>
                                                            <?php endif; ?>
                                                ...
                                                <label for="blocknotice_colorselector3">Select foreground color
                                                    <input class="form-control colorselector" type="text" name="blocknotice_colorselector3" id="blocknotice_colorselector3" value="<?php echo e(!empty($threeBlockNotice->blocknotice_colorselector3) ? $threeBlockNotice->blocknotice_colorselector3 : '##0a0a0a'); ?>" placeholder="Select foreground color" />
                                                </label>

                                                <label for="blocknoticesubtitle3">Subtitle
                                                    <input name="blocknoticesubtitle3" id="blocknoticesubtitle3" type="text" placeholder="Give this block a subtitle" value="<?php echo e(!empty($threeBlockNotice->blocknoticesubtitle3) ? $threeBlockNotice->blocknoticesubtitle3 : ''); ?>"/>
                                                </label>
                                                <label for="blocknoticedescrip3">Description
                                                    <textarea name="blocknoticedescrip3" id="blocknoticedescrip3"  placeholder="Give this block a short description" ><?php echo e(!empty($threeBlockNotice->blocknoticedescrip3) ? $threeBlockNotice->blocknoticedescrip3 : ''); ?></textarea>
                                                </label>
                                            </div>
                                        </div>
                                    </fieldset>
                                            ...
                                            <div class="information_pins">
                                                <?php if(!empty($showcasePins)): ?>
                                                    <?php $__currentLoopData = $showcasePins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="reveal" id="editPin-<?php echo e($item->id); ?>" data-reveal data-animation-in="scale-in-up">
                                                            <form >
                                                                <fieldset class="fieldset">
                                                                    <legend>Edit this pin</legend>

                                                                    <input type="text" id="pinTitle-<?php echo e($item->id); ?>" value="<?php echo e($item->show_title); ?>" placeholder="Give this pin a title" />
                                                                    <textarea  id="pinBody-<?php echo e($item->id); ?>"  placeholder="Create a showcase pin eg; snippet of info concerning the showcase." ><?php echo !empty($item->show_body) ? allowedTags($item->show_body) : '' ?></textarea>
                                                                </fieldset>

                                                                <input type="submit"
                                                                       class="button success expanded editPin"
                                                                       data-showid="<?php echo e($id['id']); ?>"
                                                                       data-pinid="<?php echo e($item->id); ?>"
                                                                       data-csrftoken="<?php echo e(\Classes\Core\CSRFToken::_SetToken()); ?>"
                                                                       value="Update Pin">
                                                        ...
                                                        <div class="reveal" id="deletePin-<?php echo e($item->id); ?>" data-reveal data-animation-in="scale-in-up">
                                                            <div class="notification"></div>
                                                            <h3 class="h3">Do you want to delete pin - <small><?php echo e($item->show_title); ?></small>?</h3>
                                                        ...
                                                        <fieldset class="fieldset" id="insertedPin-<?php echo e($item->id); ?>">
                                                            <legend>Inserted Pins: <span id="insertedPinTitle-<?php echo e($item->id); ?>"><?php echo e($item->show_title); ?></span></legend>
                                                            <div class="card">
                                                                <div class="callout">
                                                                    <span id="insertedPinBody-<?php echo e($item->id); ?>"><?php echo allowedTags($item->show_body); ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="button-group float-right">
                                                                <a  class="button primary" data-open="editPin-<?php echo e($item->id); ?>">Edit</a>
                                                                <a class="button warning" data-open="deletePin-<?php echo e($item->id); ?>">Delete</a>
                                                            </div>
                                                        </fieldset>
                                    ...
                                    <fieldset class="fieldset">
                                        ...
                                        <?php if(!empty($showcase->filename)): ?>
                                        <div class="medium-6">
                                        ...
                                        <div class="grid-x grid-padding-x">
                                            <div class="large-12 cell">
                                                <label for="frontDemo">Frontend demo url
                                                    <input type="url" id="frontDemo" name="frontDemo" value="<?php  echo (!empty($showcase->front_demo_link)) ? $showcase->front_demo_link : '';  ?>" placeholder="Enter link eg; https://frontend-demo.com">
                                                </label>
                                                <label for="backDemo">Admin demo url
                                                    <input type="url" id="backDemo" name="backDemo" value="<?php  echo (!empty($showcase->back_demo_link)) ? $showcase->back_demo_link : '';  ?>" placeholder="Enter link eg; https://backend-demo.com">
                                                </label>
                                            </div>
                                            <div class="medium-6 large-6 cell">
                                                <label for="backDemoUser">Demo admin username
                                                    <input type="text" id="backDemoUser" name="backDemoUser" value="<?php  echo (!empty($showcase->back_demo_user)) ? $showcase->back_demo_user : '';  ?>" placeholder="Enter link eg; https://backend-demo.com">
                                                </label>
                                            </div>
                                            <div class="medium-6 large-6 cell">
                                                <label for="backDemoPass">Demo admin password
                                                    <input type="text" id="backDemoPass" name="backDemoPass" value="<?php  echo (!empty($showcase->back_demo_pass)) ? $showcase->back_demo_pass : '';  ?>" placeholder="Enter link eg; https://backend-demo.com">
                                                </label>
                                            </div>
                                        </div>
                                    </fieldset>
