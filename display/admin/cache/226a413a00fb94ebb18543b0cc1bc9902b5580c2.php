            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    <table class="hover unstriped stack">
						...
						?>
                        <tr>
                            <td class="col-md-2"><a href="/admin/showcase/<?php echo e($showcase->id); ?>" class="thumbnail"> <img class="img-responsive" src="<?php echo $showcase->get_picture(); ?>" /></a>
                                ...
                                <div class="pictures_link">
                                    ...
                                    <a href="/admin/uploads/<?php echo e($showcase->id); ?>">Edit</a>
                                    <a href="/admin/showcase/<?php echo e($showcase->id); ?>">Delete</a>
