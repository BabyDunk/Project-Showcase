...
if(!\Classes\Core\Session::instance()->is_signed_in()) { redirect('/admin/login'); }
...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php sca_base_url(); ?>resources/assets/admin/css/style.css" rel="stylesheet">
...
<div id="wrapper">
    ...
    <div class="off-canvas-content admin_title_bar" data-off-canvas-content>
        <!-- Title bar -->
        <?php echo $__env->make("includes.top-nav", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php sca_base_url(); ?>resources/assets/admin/js/tinymce/tinymce.min.js"></script>
