    ...
    <div class="grid-x grid-padding-x">
                ...
                <div class="card">
                    ...
                    <div class="card-section">
                        ...
                        <form>
                            ...
                            <button type="submit" name="submit" id="commentSubmit" value="true" data-show_id="<?php echo e($id); ?>" data-csrftoken="<?php echo e(\Classes\Core\CSRFToken::_SetToken()); ?>" class="button success">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="media-object">
                ...
                <div class="media-object-section">
                    <h4 class="h4"><?php echo e($comment->author); ?>

                        <small><?php $date = new DateTime($comment->created_at);
                                echo $date->format('l jS \of F Y \@ h:i:s A'); ?></small>
                    </h4>
