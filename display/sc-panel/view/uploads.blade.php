                                            ...
                                            <li class="accordion-item <?php echo ($showcase->job_deposit) ? '' : 'is-active'; ?>" data-accordion-item>
                                                ...
                                                <div class="accordion-content" data-tab-content>
                                                    <label for="price">Price
                                                        <input class="form-control" type="number" step="0.01" name="price" id="price" value="<?php echo (!empty($showcase->price)) ? sca_show_price($showcase->price) : ''; ?>" placeholder="Set items value in &pound;" />
                                                    </label>
                                                </div>
                                            </li>
                                            <li class="accordion-item <?php echo ($showcase->job_deposit) ? 'is-active' : '' ; ?>" data-accordion-item>
